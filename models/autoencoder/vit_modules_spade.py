...
class Encoder(nn.Module):
    def __init__(self, *, ch, ch_mult=(1,2,4,8), num_res_blocks, dropout=0.0, resamp_with_conv=True, in_channels,
        ...
        self.label_embedding = nn.Embedding(9, 16384) # 16384
    ...
    def forward(self, x, cond):
        ...
        cond = repeat(cond, 'm n -> m n k', k=16) # 16
        cond = rearrange(cond, 'b (w h c) t -> b c t w h', w=128, h=128) # 128
