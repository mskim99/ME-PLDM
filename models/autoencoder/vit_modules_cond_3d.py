...
class TimeSformerEncoder(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.embedding_3d = Embeddings_3D(1, dim, [128, 128, 16], int(patch_size / 2), 0.0)
    ...
    def forward(self, video, cond, lc, frame_mask = None):
        ...
        # print('start')
        # print(b, f, h, w, p, hp, wp, b)
        # print(video.shape)

        x_2d = rearrange(video, 'b f c (h p1) (w p2) -> b (f h w) (p1 p2 c)', p1=p, p2=p)
        x_2d = self.to_patch_embedding(x_2d)
