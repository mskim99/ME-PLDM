...
class UNetModel(nn.Module):
    ...
    def forward(self, x, cond=None, timesteps=None, context=None, y=None, c_s=None, lc=0):
        ...
        h_cs_xy = h_cs[:, :, 0:16 * 16].view(h_cs.size(0), h_cs.size(1), 16, 16)
        h_cs_yt = h_cs[:, :, 16 * 16:(16 + 8) * 16].view(h_cs.size(0), h_cs.size(1), 8, 16)
        h_cs_xt = h_cs[:, :, (16 + 8) * 16:(16 + 8 + 8) * 16].view(h_cs.size(0), h_cs.size(1), 8, 16)
